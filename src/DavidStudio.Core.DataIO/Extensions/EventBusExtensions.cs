...
public static class EventBusExtensions
{
    ...
    /// and enables SSL if specified in configuration.
    /// </remarks>
    public static IServiceCollection AddRabbitMqWithTransactionalOutbox<TDbContext>(this IServiceCollection services, string? configSectionKey = null, Assembly? assembly = null)
